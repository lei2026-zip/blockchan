!function (n) {
    ...
    require.config({
        'baseUrl': '//sgoutong.baidu.com/embed/1600312793/asset/',
        'paths': {'cl': 'common/css'},
        ...
        return exports.messageHandler = function (e, n) {
            ...
            exports.decode(n, function (e) {
                if (1 == +e.role || "server" === e.role) e.recognize = n.recognize || {};
                console.log(e, n), exports.emit("message", e, o, r, n.msgHandlerType || "")
            })
        ...
        return exports.getIntelWelLan = function (t, a, c, u, l) {
            ...
            if (1 === this.isUseSmartyInvite && 1 === this.isHasSmartAccess) {
                ...
                if (i.smartBaseSetting && i.smartBaseSetting.welcome && "" !== exports.smartBackImg) s = i.smartBaseSetting.welcome.replace("\u60a8\u662f\u5426\u60f3\u54a8\u8be2\u5173\u4e8e“xxx”\u76f8\u5173\u7684\u5185\u5bb9\uff1f", s);
                b = r;
